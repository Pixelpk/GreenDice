...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['notification_signal'] != null) {
      notificationSignal = [];
      json['notification_signal'].forEach((v) { notificationSignal!.add(new NotificationSignal.fromJson(v)); });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.notificationSignal != null) {
      data['notification_signal'] = this.notificationSignal!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class NotificationSignal {
  ...
  NotificationSignal({this.id, this.signalDate, this.location, this.raceId, this.horse, this.signalFloat, this.oods, this.stake, this.placing, this.status, this.returns, this.roi, this.balance, this.profit, this.createdAt});
