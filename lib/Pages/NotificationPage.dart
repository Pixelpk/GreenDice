            ...
            children: [
              ...
              Center(
                  child: isloading ? Center(child: CircularProgressIndicator()) : ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: data == null ? 0 : notificationmodel!.data!.notificationSignal!.length,
                                  ...
                                  child: Row(
                                    children: [
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                notificationmodel!.data!.notificationSignal![index].location!,
                                                style: TextStyle(
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                notificationmodel!.data!.notificationSignal![index].raceId.toString(),
                                                style: TextStyle(
                                                    fontSize: 15, color: Colors.white),
                                                textAlign: TextAlign.left,
                                              ),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                notificationmodel!.data!.notificationSignal![index].horse!,
                                                style: TextStyle(
                                                    fontSize: 15, color: Colors.white),
                                              ),
                                            ],
                                      ...
                                      Column(
                                        children: [
                                          Text(
                                            notificationmodel!.data!.notificationSignal![index].signalDate!.split('-')[2],
                                            style: TextStyle(fontSize: 30, color: Colors.white),
                                          ),
                                          Text(
                                            monthselector(notificationmodel!.data!.notificationSignal![index].signalDate!.split('-')[1]),
                                              ...
                                              children: [
                                                Column(
                                                  children: [
                                                    ...
                                                    Text(notificationmodel!.data!.notificationSignal![index].oods!,textAlign: TextAlign.center,style: TextStyle(fontSize: 30,color: Colors.white),),
                                                  ],
                                                ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Center(child: Text(notificationmodel!.data!.notificationSignal![index].profit!,style: TextStyle(color: Colors.white),)),
